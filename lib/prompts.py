question_template_prompt = """
    ...
    Create templates for these question and solution by adding variables and keeping the language same. Also give me all the variables involved in the question, relations and also identify all the  constrains and edge cases including realistic ranges for values and potential logical or arithematical issues between them in json format. Enclose variables in curly brackets in json too.
